...
export function registerTools(server, userId) {
  ...
  }, async ({ text, platforms, imageUrl, videoUrl, videoData, imageData, mediaMimeType, campaignName }) => {
    try {
  ...
  }, async ({ text, platforms, scheduledAt, imageUrl, videoUrl, videoData, imageData, mediaMimeType, campaignName }) => {
    try {
